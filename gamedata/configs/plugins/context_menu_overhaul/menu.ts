  ...
  return [
    ...
    f.ltx({
      ...
      entries: {
        ...
        default: 2,
        ui_haru_add_item_to_qaw: 3,
        ui_haru_add_item_to_first_wheel: 3,
        ui_haru_add_item_to_second_wheel: 3,
        "bind_item.menu_separate": 4,
        st_cai_combine_all: 4,
        DYN_FUNC_SP_fav: 5,
        DYN_FUNC_SP_junk: 5,
        drop: 6,
        drop_all: 6,
        "item_parts.menu_disassembly": 7,
        st_batch_breakdown: 7,
        st_dai_disassemble_all: 7,
        st_dai_disassemble_all_junk: 7,
      },
    }),
    f.ltx({
      section: "chevrons",
